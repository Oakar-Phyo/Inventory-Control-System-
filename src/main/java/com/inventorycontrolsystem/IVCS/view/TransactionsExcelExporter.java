...
public class TransactionsExcelExporter {
	...
	//Export Inventory Receive
		...
		public TransactionsExcelExporter(List<StockIn> listReceives) {
		...
		private void writeHeaderLine() {
			sheet = workbook.createSheet("Inventory Receives");
		...
		private void writeDataLines() {
			...
			// Top Data Rows
			createCell(sheet.createRow(0), 0, "Inventory Receive Transaction Details" , styleH);
			
			//Upper Part(Table is Created)
			//This data needs to be written (Object[])
	        Map<String, Object[]> data = new TreeMap<String, Object[]>();
	        data.put("1", new Object[] {"Receive No.:  "+ listReceives.get(0).getCode(), "Date"+listReceives.get(0).getDate()});
	        data.put("2", new Object[] {"Warehouse Code:  "+listReceives.get(0).getWarehouse().getWarehouseCode(), "Currency:  "+listReceives.get(0).getCurrency().getName()});
	        data.put("3", new Object[] {"Warehouse Name:  "+listReceives.get(0).getWarehouse().getName(), "Exchange Rate:  "+listReceives.get(0).getExchangeRate()});
	        data.put("4", new Object[] {"Supplier Code:  "+listReceives.get(0).getSupplier().getSupplierCode(), " "});
	        data.put("5", new Object[] {"Supplier Name:  "+listReceives.get(0).getSupplier().getName(), " "});
