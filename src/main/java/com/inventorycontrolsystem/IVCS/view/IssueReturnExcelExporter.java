...
public class IssueReturnExcelExporter {
	...
	//Export Inventory Receive
			...
			public IssueReturnExcelExporter(List<IssueReturn> listissRtn) {
			...
			private void writeHeaderLine() {
				sheet = workbook.createSheet("Inventory Issue Return");
				...
				createCell(row, 3, "Issue Quantity", style);
			...
			private void writeDataLines() {
				...
				// Top Data Rows
				createCell(sheet.createRow(0), 0, "Inventory Issue Return Transaction Details" , styleH);
				
				//Upper Part(Table is Created)
				//This data needs to be written (Object[])
		        Map<String, Object[]> data = new TreeMap<String, Object[]>();
		        data.put("1", new Object[] {"Issue Return No.:  "+ listissRtn.get(0).getCode(), "Department Code :"+listissRtn.get(0).getDepartment().getDepCode()});
		        data.put("2", new Object[] {"Issue No. :  "+listissRtn.get(0).getIssueCode(), "Department Name :  "+listissRtn.get(0).getDepartment().getName()});
		        data.put("3", new Object[] {"Warehouse Code :  "+listissRtn.get(0).getWarehouse().getId(), "Date :  "+listissRtn.get(0).getDate()});
		        data.put("4", new Object[] {"Warehouse Name:  "+listissRtn.get(0).getWarehouse().getName(), " "});
		        //data.put("5", new Object[] {"Supplier Name:  "+listissRtn.get(0).getSupplier().getName(), " "});
				...
				// Total & Remark
				createCell(sheet.createRow(16), 0, "Remark:  " + listissRtn.get(0).getRemark() , style1);
