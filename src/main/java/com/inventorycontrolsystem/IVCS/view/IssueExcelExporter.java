...
public class IssueExcelExporter {
	//Export Warehouse Transfer
			...
			public IssueExcelExporter(List<Issue> listIssue) {
			...
			private void writeHeaderLine() {
				sheet = workbook.createSheet("Issue");
				...
				createCell(row, 4, "Issue Quantity", style);
			...
			private void writeDataLines() {
				...
				// Top Data Rows
				createCell(sheet.createRow(0), 0, "Issue View Details" , styleH);
				
				//Upper Part(Table is Created)
				//This data needs to be written (Object[])
		        Map<String, Object[]> data = new TreeMap<String, Object[]>();
		        data.put("1", new Object[] {"Issue No:  "+ listIssue.get(0).getIssueCode(), "Issue Date:  "+listIssue.get(0).getDate()});
		        data.put("2", new Object[] {"Warehouse Code:  "+listIssue.get(0).getWarehouse().getWarehouseCode(), "Department Code:  "+listIssue.get(0).getDepartment().getDepCode()});
		        data.put("3", new Object[] {"Warehouse Name:  "+listIssue.get(0).getWarehouse().getName(), "Department Name:  "+listIssue.get(0).getDepartment().getName()});
				...
				for (Issue receive : listIssue) {
					...
					tQty = receive.getIssueQty()+ tQty;
					tAmt = receive.getSubTotalAmount() + tAmt;
				}

				// Total & Remark
				createCell(sheet.createRow(16), 0, "Remark:  " + listIssue.get(0).getRemark() , style1);
