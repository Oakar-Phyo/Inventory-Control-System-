...
public class IssueReportPDFExporter {
	private List<Issue> listIssue;
	
	 public  IssueReportPDFExporter(List<Issue> listIssue) {
	 ...
	 private void writeTableData(PdfPTable table) {
	        ...
	        for (Issue receivereturn : listIssue) {
	        	...
	        	table.addCell(receivereturn.getIssueCode());
	            ...
	            table.addCell(receivereturn.getDepartment().getName());
...
//	        pdfPTable.addCell(pdfPCell10);
	        ...
	        //Adding Header
	        Paragraph p = new Paragraph("Inventory Issue Report", font);
