...
public class ReceiveReturnReportPDFExporter {
	private List<StockOut> stockOutList;
	
	 public  ReceiveReturnReportPDFExporter(List<StockOut> stockOutList) {
	 ...
	 private void writeTableHeader(PdfPTable table) {
	        ...
	        cell.setPhrase(new Phrase("Receive Return No", font));
	        table.addCell(cell);
	 ...
	 private void writeTableData(PdfPTable table) {
			int totalNo = 1;
	        for (StockOut receiveReturn : stockOutList) {
	            ...
	            table.addCell(String.valueOf(receiveReturn.getReturnqty()));
...
//	        pdfPTable.addCell(pdfPCell10);
	        ...
	        //Adding Header
	        Paragraph p = new Paragraph("Receive Return Report", font);
