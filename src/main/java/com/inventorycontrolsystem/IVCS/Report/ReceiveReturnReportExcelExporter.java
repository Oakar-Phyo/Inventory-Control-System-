...
public class ReceiveReturnReportExcelExporter {
	//Export Warehouse Transfer
	private XSSFWorkbook workbook;
	private XSSFSheet sheet;
	private List<StockOut> receiveReturnList;
	
	public ReceiveReturnReportExcelExporter(List<StockOut> receiveReturnList) {
		this.receiveReturnList = receiveReturnList;
		workbook = new XSSFWorkbook();
	}
	
    //Warehouse Transfer Report
			private void writeHeaderLine() {
				sheet = workbook.createSheet("Receive Return Report");
				...
				createCell(row, 1, "Receive Return No", style);
				...
				createCell(row, 6, "Supplier", style);
			...
			private void writeDataLines() {
				...
				for (StockOut receive : receiveReturnList) {
