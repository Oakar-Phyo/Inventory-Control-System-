...
public class WarehouseTransferReportPDFExporter {
	private List<WarehouseTransfer> listTransfers;
	
	 public  WarehouseTransferReportPDFExporter(List<WarehouseTransfer> listTransfers) {
	 ...
	 private void writeTableHeader(PdfPTable table) {
	        ...
	        cell.setPhrase(new Phrase("Warehouse Transfer No", font));
	        table.addCell(cell);
	        ...
	        cell.setPhrase(new Phrase("From Warehouse Name", font));
	        table.addCell(cell);
	        
	        cell.setPhrase(new Phrase("To Warehouse Name", font));
	        table.addCell(cell);
...
//	        pdfPTable.addCell(pdfPCell10);
	        ...
	        //Adding Header
	        Paragraph p = new Paragraph("Warehouse Transfer Report", font);
...
//	        table.setWidths(new float[] {1.5f, 3.0f, 3.0f, 4.0f, 4.3f,3.0f,3.0f,4.0f,3.0f,3.0f});
