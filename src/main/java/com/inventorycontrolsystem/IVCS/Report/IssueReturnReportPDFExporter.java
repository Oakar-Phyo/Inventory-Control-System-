...
public class IssueReturnReportPDFExporter {

	private List<IssueReturn> listIssRtn;
	
	 public  IssueReturnReportPDFExporter(List<IssueReturn> listIssRtn) {
	 ...
	 private void writeTableHeader(PdfPTable table) {
	        ...
	        cell.setPhrase(new Phrase("Issue Return No", font));
	        table.addCell(cell);
	        ...
	        cell.setPhrase(new Phrase("Warehouse", font));
	        table.addCell(cell);
	 ...
	 private void writeTableData(PdfPTable table) {
	        ...
	        for (IssueReturn issRtn : listIssRtn) {
	        	...
	        	table.addCell(issRtn.getCode());
	            table.addCell(issRtn.getStock().getStockCode());
	            table.addCell(issRtn.getStock().getName());
	            table.addCell(issRtn.getWarehouse().getName());
	            table.addCell(issRtn.getDepartment().getName());
	            table.addCell(String.valueOf(issRtn.getStock().getUnit().getName()));
	            table.addCell(String.valueOf(issRtn.getIssueQty()));
	            table.addCell(String.valueOf(issRtn.getReturnqty()));
	            table.addCell(String.valueOf(issRtn.getDate()));
...
//	        pdfPTable.addCell(pdfPCell10);
	        ...
	        //Adding Header
	        Paragraph p = new Paragraph("Inventory Issue Return Report", font);
	       ...
	       //Upper Part of the Page Ends(Hidden Table)
	        ...
	        table.setWidths(new float[] {1.5f, 3.5f, 3.5f, 4.0f, 4.5f, 4.5f,3.0f,3.5f,5.0f,3.0f,3.5f,3.5f});
